...
public class TopologicalSortTest {
    ...
    @DisplayName("[그래프 알고리듬] 위상 정렬 코드 작성")
    @Test
    void test() {
    ...
    private LinkedList<Course> sortTopologically(ArrayList<Course> courses) {
    ...
    private void topologicalSortRecursive(Course course, HashSet<Course> discovered, LinkedList<Course> linkedList) {
        ...
        for (Course nextCourse : course.getNextCourses()) {
            ...
            topologicalSortRecursive(nextCourse, discovered, linkedList);
        }
    ...
    private ArrayList<Course> createCourseGraph() {
